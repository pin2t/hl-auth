...
#CMD ["java", "-XX:+HeapDumpOnOutOfMemoryError", "-XX:HeapDumpPath=/storage/data", "-XX:+FlightRecorder", "-XX:StartFlightRecording=disk=true,filename=/storage/data/recording.jfr,maxage=24h,dumponexit=true,path-to-gc-roots=true", "-jar", "/app/auth-1.0.jar"]
